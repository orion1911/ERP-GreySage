            ...
            {!loading && (
                <>
                    ...
                    <Grid container spacing={2} sx={{ mb: 4, alignItems: 'stretch' }}>
                        ...
                        <Grid size={{ xs: 6, sm: 6, md: 3 }}>
                            <KPICard label="Making" value={kpiData.totalMaking} subtitle="In production" color="#E8634A" icon={LocalShippingIcon} />
                        </Grid>
                        <Grid size={{ xs: 6, sm: 6, md: 3 }}>
                                                ...
                                                clientSummary.map((row, idx) => (
                                                    <TableRow key={idx} hover>
                                                        ...
                                                        <TableCell align="center">
                                                            <Chip label={formatNumber(row.MAKING || 0)} size="small" color="error" variant="filled" sx={{ opacity: 0.7 }} />
                                                        </TableCell>
                                                        <TableCell align="center">
                                                            <Chip label={formatNumber(row.IN_WASHING || 0)} size="small" color="warning" variant="filled" sx={{ opacity: 0.7 }} />
                                                        </TableCell>
                                                        <TableCell align="center">
                                                            <Chip label={formatNumber(row.OUT_WASHING || 0)} size="small" color="success" variant="filled" sx={{ opacity: 0.7 }} />
                                                        </TableCell>
                                                    </TableRow>
                                                ))
                                            ) : (
                                            ...
                                            {washerSummary.length > 0 ? (
                                                washerSummary.map((row, idx) => (
                                                    <TableRow key={idx} hover>
                                                        ...
                                                        <TableCell align="center">
                                                            <Chip label={formatNumber(row.PENDING || 0)} size="small" color="error" variant="filled" sx={{ opacity: 0.7 }} />
                                                        </TableCell>
                                                    </TableRow>
                                                ))
                                            ) : (
                                        ...
                                        breakdownData.slice(0, 100).map((row, idx) => {
                                            ...
                                            return (
                                                <TableRow key={idx} hover>
                                                    ...
                                                    <TableCell align="center">
                                                        <Chip label={status} size="small" color={getStatusBadgeColor(status)} variant="filled" sx={{ opacity: 0.7 }} />
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })
