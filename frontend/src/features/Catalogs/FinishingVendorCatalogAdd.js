...
function FinishingVendorCatalogAdd({ open, onClose, loading, setLoading, onAddSuccess, editVendor }) {
  ...
  const onSubmit = (data) => {
    ...
    const request = editVendor
      ? apiService.finishingVendors.updateFinishingVendor(editVendor._id, payload)
      : apiService.finishingVendors.createFinishingVendor(payload);
...
export default FinishingVendorCatalogAdd;